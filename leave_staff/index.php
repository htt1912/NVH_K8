...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Trình quản lý nghỉ phép</title>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Chào mừng bạn đã quay trở lại hệ thống</h2>
						</div>
						<form name="signin" method="post">
							...
							<div class="row pb-30">
								...
								<div class="col-6">
									<div class="forgot-password"><a href="forgot-password.html">Quên mật khẩu</a></div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									   <input class="btn btn-primary btn-lg btn-block" name="signin" id="signin" type="submit" value="Đăng nhập">
									</div>
								</div>
							</div>
						</form>
