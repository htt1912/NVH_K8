	...
	<div class="main-container">
		<div class="pd-ltr-20">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Đã chấp nhận nghỉ</div>
							</div>
							<div class="widget-icon">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Đang chờ nghỉ phép</div>
							</div>
							<div class="widget-icon">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($leavecount); ?></div>
								<div class="font-14 text-secondary weight-500">Đã từ chối nghỉ phép</div>
							</div>
							<div class="widget-icon">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">Đơn xin nghỉ gần đây</h2>
					</div>
				<div class="pb-20">
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="leave_details.php?leaveid=<?php echo $row['lid']; ?>"><i class="dw dw-eye"></i> Xem</a>
											<a class="dropdown-item" href="admin_dashboard.php?leaveid=<?php echo $row['lid']; ?>"><i class="dw dw-delete-3"></i> Xóa</a>
										</div>
									</div>
								</td>
							</tr>
