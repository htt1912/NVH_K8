					...
					<div class="page-header">
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="title">
									<h4>Danh sách loại nghỉ phép</h4>
								</div>
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="admin_dashboard.php">Dashboard</a></li>
										<li class="breadcrumb-item active" aria-current="page">Sửa loại nghỉ phép</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Sửa loại nghỉ phép</h2>
								<section>
									<?php
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Mô tả nghỉ phép</label>
									...
									<div class="col-sm-12 text-right">
										<div class="dropdown">
										   <input class="btn btn-primary" type="submit" value="Cập nhật" name="edit" id="edit">
									    </div>
									</div>
								   </form>
							    </section>
						...
						<div class="col-lg-8 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Danh sách loại nghỉ phép</h2>
								<div class="pb-20">
									<table class="data-table table stripe hover nowrap">
										<thead>
										<tr>
											<th class="table-plus">Loại nghỉ phép</th>
											<th class="table-plus">Mô tả</th>
											<th table-plus>Lọc ngày</th>
