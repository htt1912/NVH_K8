...
if (isset($_POST["update_image"])) {
	...
	if(!empty($image)){
		...
		echo "<script>alert('Chọn ảnh để cập nhật!');</script>";
	}

    $result = mysqli_query($conn,"update tblemployees set location='$location' where emp_id='$session_id'         
		")or die(mysqli_error());
    if ($result) {
     	echo "<script>alert('Đã cập nhật trang cá nhân!');</script>";
     	echo "<script type='text/javascript'> document.location = 'my_profile.php'; </script>";
	} else{
	  die(mysqli_error());
   }
							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Bản ghi nghỉ phép</a>
										</li>
										<li class="nav-item">
											...
											<div class="profile-setting">
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														<div class="col-md-12"><h4 class="text-blue h5 mb-20">Sửa cài đặt cá nhân</h4></div>
														...
														<div class="weight-500 col-md-6">
															...
															?>
															<div class="form-group">
																<label>Ngày nghỉ phép có sẵn</label>
