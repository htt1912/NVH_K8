		...
		<div class="pd-ltr-20">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Chi tiết lịch nghỉ</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="admin_dashboard.php">Trang chủ</a></li>
									<li class="breadcrumb-item active" aria-current="page">Lịch nghỉ</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Chi tiết nghỉ</h4>
							<p class="mb-20"></p>
						</div>
					</div>
					<form method="post" action="">
						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Tên</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Số ngày nghỉ</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Số ngày cho phép</b></label>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Thời gian nghỉ phép</b></label>
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Lý do nghỉ</b></label>
								<div class="col-sm-12 col-md-10">
									<textarea name=""class="form-control text_area" readonly type="text"><?php echo htmlentities($result->Description);?></textarea>
								</div>
						</div>
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Đang chờ nhận xét</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Đăng ký nhận xét</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b>Rời khỏi trạng thái từ trưởng phòng</b></label>
