	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Phân tích hành chính</h2>
			</div>
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Trưởng phòng ban</div>
							</div>
							<div class="widget-icon">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">Tất cả nhân viên</h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus">Họ tên</th>
								<th>Email</th>
								<th>Phòng ban</th>
								<th>Chức vụ</th>
								<th>Nghỉ</th>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="edit_staff.php?edit=<?php echo $row['emp_id'];?>"><i class="dw dw-edit2"></i> Sửa</a>
											<a class="dropdown-item" href="staff.php?delete=<?php echo $row['emp_id'] ?>"><i class="dw dw-delete-3"></i> Xóa</a>
										</div>
									</div>
								</td>
							</tr>
