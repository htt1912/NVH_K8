...
<?php
	...
	<?php
		...
		") or die(mysqli_error()); ?>
		<script>alert('Thêm thành công!');</script>;
		<script>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Module nhân viên</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form nhân viên</h4>
							<p class="mb-20"></p>
						</div>
					</div>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="user_role" class="custom-select form-control" required="true" autocomplete="off">
												...
												<option value="HOD">Trường phòng</option>
